...
# input_csv_path = os.path.join(root_directory, 'object_dataset.csv')
# image_directory = os.path.join(root_directory, 'object_detection/')
# output_directory = os.path.join(root_directory, 'object_detection_annotations/')


input_csv_path = os.path.join(root_directory, '/Users/kajalshukla/Desktop/ASL/tello_camera/drone_camera.csv')
image_directory = os.path.join(root_directory, '/Users/kajalshukla/Desktop/ASL/tello_camera/data')
output_directory = os.path.join(root_directory, '/Users/kajalshukla/Desktop/ASL/tello_camera/object_detection_annotations/')
